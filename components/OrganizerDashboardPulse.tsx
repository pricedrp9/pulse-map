    ...
    return (
        <div className="relative">
            <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 bg-blue-100 hover:bg-blue-200 text-blue-800 rounded-full text-xs font-bold transition-colors"
            >
                                ...
                                participants.map((p) => (
                                    <div key={p.id} className="flex items-center justify-between p-2 rounded-xl bg-slate-50">
                                        ...
                                        {p.is_completed ? (
                                            ...
                                            <span className="text-[10px] font-bold text-slate-400 bg-slate-200 px-2 py-0.5 rounded-full flex items-center gap-1">
                                                <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
